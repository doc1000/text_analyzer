...
1. **Cloud (recommended for review):** 
Site with fully function within Firefox brownser at https:\\vaultbubbles.fly.dev. You'll be able to see the pages you capture there.  You use the same login credentials at the site.  When you log into the extension, you'll be directed to the site.

Or you can sign up or log in at [https://vaultbubbles.fly.dev](https://vaultbubbles.fly.dev). No additional download required. Use the extension Settings (gear icon) to set the server to cloud.
...
2. Click **Connect** (or open Settings) and use provided email and code (input the 6 digit code in place of emailed code)
...
4. Verify the capture appears in your vault at the configured server at https:\\vaultbubbles.fly.dev
